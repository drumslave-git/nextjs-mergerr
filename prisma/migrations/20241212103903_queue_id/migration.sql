/*
  ...
  - Added the required column `queueId` to the `Merge` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Merge" ("app_id", "error", "id", "movieId", "progress", "result", "status", "tmdbId") SELECT "app_id", "error", "id", "movieId", "progress", "result", "status", "tmdbId" FROM "Merge";
DROP TABLE "Merge";
